        ...
        <div className="mt-10 space-y-10 text-[15px] leading-relaxed text-[#0F2A47]/85">
          <Section title="1. Quem somos">
            <p>
              ...
              Campolino Alves, 300, Capoeiras, Florianópolis, CEP 88085110.
            </p>
          ...
          <Section title="6. Modo Casal - compartilhamento de orçamento">
            ...
            <p>Ao ativar o Modo Casal ou aceitar um convite, você declara estar ciente e de acordo que:</p>
            <p>
            ...
            <h3 className="mt-4 font-semibold text-[#0F2A47]">6.1 Encerramento do compartilhamento</h3>
            <p>
          ...
          <Section title="8. Direito de arrependimento e garantia de 7 dias">
            ...
            <p>O uso do Aplicativo durante o período de 7 dias não afasta o direito de arrependimento.</p>
          </Section>

          <Section title="9. Uso permitido e condutas vedadas">
            <p>Você concorda em não:</p>
            <p>a) usar o Serviço para qualquer finalidade ilícita, fraudulenta ou que viole direitos de terceiros;</p>
            <p>b) tentar acessar contas, dados ou áreas do sistema sem autorização;</p>
            <p>c) realizar engenharia reversa, descompilar, copiar ou criar obra derivada do Aplicativo;</p>
            ...
            <p>g) inserir conteúdo ilegal, ofensivo, difamatório ou que viole direito de terceiro nos campos de texto livre;</p>
          ...
          <Section title="11. Proteção de dados pessoais (LGPD)">
            ...
            <ul className="list-disc space-y-1 pl-6">
              ...
              <li>
                ...
                consentimento - pelo e-mail admin@educarbem.com.br;
              </li>
              <li>
          ...
          <Section title="19. Contato">
            <p>Romana Multiplataforma Ltda — CNPJ 48.570.356/0001-97</p>
